package com.example.festivalcarpet.repository;

import android.util.Log;
import androidx.annotation.NonNull;

import com.example.festivalcarpet.data.ApiClient;
import com.example.festivalcarpet.data.ApiService;
...
import com.example.festivalcarpet.model.OnApiResponse;
...
*/
    ...
    public void remoteBooking(String token, Booking booking, OnApiResponse onApiResponse){
        Call<com.example.festivalcarpet.model.BookingResponse> call = apiService.RentRequest(token, booking);
        call.enqueue(new Callback<BookingResponse>() {
            @Override
            public void onResponse(@NonNull Call<BookingResponse> call, @NonNull Response<BookingResponse> response) {
