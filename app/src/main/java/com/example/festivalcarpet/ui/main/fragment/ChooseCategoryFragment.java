...
import com.example.festivalcarpet.ui.main.fragment.navigation.HomeFragment;
...
public class ChooseCategoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        carCategory = view.findViewById(R.id.category_cardView_silkCarpet);
        busCategory=view.findViewById(R.id.category_cardView_acrylicCarpet);
        motorcycleCategory=view.findViewById(R.id.category_cardView_shagCarpet);
