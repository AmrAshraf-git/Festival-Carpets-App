package com.example.festivalcarpet.ui.main.fragment;
...
import com.example.festivalcarpet.constant.DateConverter;
import com.example.festivalcarpet.model.Booking;
import com.example.festivalcarpet.model.BookingResponse;
import com.example.festivalcarpet.ui.main.VehicleViewModel;
import com.example.festivalcarpet.utility.SessionManager;
...
public class ConfirmationFragment extends Fragment implements DatePickerDialog.OnDateSetListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        vehicleImageImgView = view.findViewById(R.id.confirmation_imgView_imageOfItem);
        vehicleModelTxtView = view.findViewById(R.id.confirmation_txtView_ItemModel);
        vehiclePriceTxtView = view.findViewById(R.id.confirmation_txtView_ItemPrice);

        pickUpDateCard = view.findViewById(R.id.confirmation_cardView_ChooseDeliveryDay);
        pickUpDayOfMonthTxtView = view.findViewById(R.id.confirmation_txtView_DayOfMonth);
        pickUpDayOfWeekTxtView = view.findViewById(R.id.confirmation_txtView_DayOfWeek);
        pickUpMonthTxtView = view.findViewById(R.id.confirmation_txtView_Month);
